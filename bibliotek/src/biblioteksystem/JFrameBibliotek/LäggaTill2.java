 ...
 */
public class LäggaTill2 extends javax.swing.JFrame {

    /**
     * Creates new form LäggaTill2
     */
    public LäggaTill2() {
        initComponents();
    }
...
String namn=b1.getText();
String år=b2.getText();
String genre=this.b4.getText();
String författare=b3.getText();
//Connection con=Databas.getConnection();
SqlKommandon sqlkom = new SqlKommandon();
sqlkom.läggaTillMedia(namn, år, genre, författare);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LäggaTill2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LäggaTill2().setVisible(true);
            }
        });
    }
